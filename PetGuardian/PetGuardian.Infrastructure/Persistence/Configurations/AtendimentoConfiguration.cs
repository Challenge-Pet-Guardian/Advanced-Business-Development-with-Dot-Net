...
public sealed class AtendimentoConfiguration : IEntityTypeConfiguration<Atendimento>
{
    public void Configure(EntityTypeBuilder<Atendimento> builder)
    {
        ...
        builder.Property(a => a.VeterinariaId).HasColumnName("ID_VETERINARIA").IsRequired();
        ...
        builder.HasIndex(a => a.TipoAtendId).IsUnique();
        ...
        builder.HasOne(a => a.Status)
            ...
            .OnDelete(DeleteBehavior.Restrict);
        builder.HasIndex(a => a.StatusId).IsUnique();
    }
}